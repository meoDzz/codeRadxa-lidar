...
## 5. Run
```
ros2 run cartographer_ros cartographer_node -configuration_directory ~/ros2_ws/src/carto_jazzy_ws -configuration_basename handheld_jazzy.lua --ros-args -p use_sim_time:=false
```
